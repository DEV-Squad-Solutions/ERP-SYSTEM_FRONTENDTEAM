...
export default function AfterAdjustmentTrialBalancePage() {
      ...
      <div className="mb-5 flex items-start justify-between gap-4">
        ...
        <div>
          ...
          <p className="mt-1 text-sm text-ink-400">
            أرصدة وحركات الخزائن والعملاء والموردين والسائقين والموظفين
            والإيرادات والمصروفات بعملة الشركة الأساسية بعد قيود التسوية
          </p>
        </div>
        <button
          type="button"
