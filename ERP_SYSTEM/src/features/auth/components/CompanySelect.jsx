    ...
    <div dir="rtl" className="w-full min-w-0">
      ...
      {filteredCompanies.length > 0 ? (
        <div className="relative min-w-0">
          <div className="custom-scroll max-h-[38vh] space-y-2 overflow-y-auto overflow-x-hidden overscroll-contain px-0.5 pb-0.5 sm:max-h-[42vh]">
              ...
              return (
                <button
                  ...
                  className={`group relative flex w-full min-w-0 items-center gap-3 overflow-hidden rounded-xl border px-3 py-3 text-right transition-[transform,background-color,border-color,box-shadow] duration-200 ease-out motion-safe:animate-[companyIn_0.35s_ease-out_both] active:scale-[0.99] disabled:cursor-not-allowed disabled:opacity-65 ${
                    isSelected
                      ? "border-primary-500 bg-primary-500/[0.06] shadow-sm shadow-primary-500/5"
                      : "border-ink-200 bg-white hover:-translate-y-0.5 hover:border-primary-500/40 hover:bg-primary-500/[0.025] hover:shadow-sm"
                  }`}
                >
                  <span
                    className={`flex h-10 w-10 shrink-0 items-center justify-center rounded-xl transition-[background-color,color,transform] duration-200 ${
                      isSelected
                        ? "bg-primary-500 text-white"
                        : "bg-primary-500/10 text-primary-500 group-hover:scale-105 group-hover:bg-primary-500 group-hover:text-white"
                    }`}
                  >
                  ...
                  <span
                    className={`flex h-8 w-8 shrink-0 items-center justify-center rounded-lg transition-[background-color,color,transform] duration-200 ${
                      isSelected
                        ? "bg-primary-500/10 text-primary-500"
                        : "text-ink-400/40 group-hover:bg-primary-500/10 group-hover:text-primary-500"
                    }`}
                  >
                    {isSelected && !isLoading ? (
