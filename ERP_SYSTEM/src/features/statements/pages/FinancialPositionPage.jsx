    ...
    <div className="animate-fadeUp" dir="rtl">
      ...
      <div className="mb-5 flex items-start justify-between gap-4">
        ...
        <div>
          ...
          <p className="mt-1 text-sm text-ink-400">
            الأصول والالتزامات وحقوق الملكية حتى نهاية الفترة
          </p>
        </div>
        <button
          type="button"
      ...
      {data && (
        <>
            ...
            <div className="mb-5 flex items-start gap-3 rounded-2xl border border-amber-200 bg-amber-50 p-4 text-amber-700">
              ...
              <div>
                ...
                <p className="mt-1 text-sm">
                  توجد حركات أو تسويات معلقة قد تؤثر على أرصدة المركز المالي.
                </p>
              </div>
            </div>
          )}
            ...
            <div className="mb-5 grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-4">
              ...
              <div className="rounded-2xl border border-ink-400/10 bg-white p-5 shadow-card">
                <div className="mb-3 flex items-center justify-between">
                  ...
                  <Scale size={20} className="text-ink-500" />
                </div>

                <p className="text-2xl font-bold text-ink-900">
                  {fmt(totals.totalLiabilitiesAndEquity)}
                </p>
              ...
              >
                <div className="mb-3 flex items-center justify-between">
                  <span
                    className={`text-sm ${
                      totals.isBalanced ? "text-primary-700" : "text-rose-700"
                    }`}
                  >
                    حالة التوازن
                  </span>
                ...
                <span
                  className={`text-xs ${
                    totals.isBalanced ? "text-primary-600" : "text-rose-600"
                  }`}
                >
              ...
              <table className="w-full min-w-[1050px] text-sm">
                ...
                <tbody>
                  {paginatedItems.length === 0 ? (
                    <tr>
                      <td
                        colSpan={applied.viewMode === "Detailed" ? 8 : 7}
                    ...
                    paginatedItems.map((row, idx) => (
                      ...
                      >
                        ...
                        <td className="whitespace-nowrap px-3 py-3 text-primary-600">
                          {fmt(row.periodDebit)}
                        </td>

                        <td className="whitespace-nowrap px-3 py-3 text-rose-600">
                          {fmt(row.periodCredit)}
                        </td>

                        <td className="whitespace-nowrap px-3 py-3 font-semibold text-ink-800">
            ...
            <div className="mt-5 overflow-hidden rounded-2xl border border-amber-200 bg-white shadow-card">
              <div className="border-b border-amber-100 bg-amber-50 px-4 py-3">
                ...
                <p className="mt-1 text-xs text-amber-600">
                  هذه الحسابات لها حركة ولكن لم يتم ربطها ببند في المركز المالي.
                </p>
              </div>
          ...
          {data.isReadyForReporting && totals?.isBalanced && (
            <div className="mt-4 flex items-center gap-2 text-xs text-primary-600">
              <CheckCircle2 size={15} />
              قائمة المركز المالي جاهزة ومتوازنة.
            </div>
          )}
        </>
      )}
